...
public class IntroductionPointFactory {
	WebDriver driver;
	...
	public static final String PAGE_TITLE = "紹介ポイント";
	public static final String BOX_PAGE_TITLE = "紹介ポイント";

	public IntroductionPointFactory(WebDriver driver) {
		this.driver = driver;
